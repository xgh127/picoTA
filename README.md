...
`picoTA` 是一个面向实习项目管理场景的项目助教 Agent。项目目标不是替代实习生完成任务，而是围绕实习项目过程提供每日陪跑、阶段复盘、任务拆解、产物检查、导师同步提醒和可量化评测能力。
...
`picoTA` 将实习项目管理中的日报、周报、进度、风险、导师同步等流程统一到一个可追踪的 Agent 闭环中：
...
Context / Tools / RAG / Skill / Harness
        ↓
日报、周报、进度、风险、导师同步、质量检查
        ↓
Trace / State / Benchmark
```

它强调最小权限、证据支撑、过程可追踪和评测可复现，适合用于实习项目辅助、过程管理和阶段性汇报演示。
