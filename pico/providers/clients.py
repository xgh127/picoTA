...
class FakeModelClient:
    def __init__(self, outputs, context_window=None):
...
class OllamaModelClient:
    def __init__(self, model, host, temperature, top_p, timeout, context_window=None):
        self.model = model
...
class OpenAICompatibleModelClient:
    def __init__(self, model, base_url, api_key, temperature, timeout, context_window=None):
        self.model = model
